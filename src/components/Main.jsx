...
const Main = () => {
    ...
    const {watchlist, addToWatchList, removeFromWatchList, removeAllWatchList} = useWatchList();
  ...
  return (
    ...
    <div className='overflow-hidden'>
        <div className='py-3 px-10 relative flex flex-col items-end'>
            ...
            {isModalOpen && <WatchListModal watchlist={watchlist} removeAllWatchList={removeAllWatchList} onClose={()=> {setIsModalOpen(false)}} removeFromWatchList={removeFromWatchList}/>}
